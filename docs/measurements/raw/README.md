...
| `2026-09-03-interop-old-dialler.txt` | twelve bench trials from the released image against the public serving half after it moved to this commit |
| `2026-09-04-interop-new-dialler.txt` | the other direction, two containers: an acceptor built from the released pin and a dialler built from the branch |
